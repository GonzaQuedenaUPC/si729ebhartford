package org.hign.platform.hartford.assessment.interfaces.rest;
...
import org.hign.platform.hartford.assessment.interfaces.rest.transform.CreateMentalStateExamCommandFromResourceAssembler;
import org.hign.platform.hartford.assessment.interfaces.rest.transform.MentalStateExamResourceFromEntityAssembler;
...
public class MentalStateExamsController {
    ...
    public ResponseEntity<MentalStateExamResource> createMentalStateExam(@RequestBody
                                                                             CreateMentalStateExamResource resource) {
        ...
        var mentalStateExamResource = MentalStateExamResourceFromEntityAssembler.toResourceFromEntity(
                createdMentalStateExam);
